from ..models import Beach, DesciptionPoints
from ..extensions import db


def seedDescriptionPoints(app):
    ...
    if db.session.query(Beach).count() < 1:
        db.session.add(
            ...
            Beach(
                ...
                restaurants=5,
                pubs=2,
                surf_fore_cast_link='<link href="//www.surf-forecast.com/stylesheets/widget.css" media="screen" '
            ...
            Beach(
                ...
                description="Playa la Carihuela in Andalucia is an exposed beach break that has inconsistent "
                            "surf. Winter is the favoured time of year for surfing here. The best wind direction "
                            "is from the northwest. There is too little fetch for groundswells to form and the "
                            "best wave direction is from the southeast. The beach break provides left and right "
            ...
            Beach(
                ...
                restaurants=5,
                pubs=4,
                surf_fore_cast_link='<link href="//www.surf-forecast.com/stylesheets/widget.css" media="screen" rel="stylesheet" type="text/css" /><div class="wf-width-cont surf-fc-widget"><div class="widget-container"><div class="external-cont"><iframe class="surf-fc-i" allowtransparency="true" src="//www.surf-forecast.com/breaks/Cabopino/forecasts/widget/a" scrolling="no" frameborder="0" marginwidth="0" marginheight="0"></iframe>></div></div></div>',
            ...
            Beach(
                ...
                description="Puerto Marina in Andalucia is a fairly exposed sandbar break that has inconsistent surf. Autumn and winter are the optimum times of year for waves. Works best in offshore winds from the north northwest with some shelter here from southwest winds. Most of the surf comes fis in the form of windswells and the best wave direction is from the southeast. The sandbar break provides left and right handers. Surfable at all stages of the tide. It's often crowded here.",
                type="Sandbar",
                flag=2,
                quality_when_it_works=3,
                wave_consistency=3,
                ...
                restaurants=5,
                pubs=5,
                surf_fore_cast_link='<link href="//www.surf-forecast.com/stylesheets/widget.css" media="screen" rel="stylesheet" type="text/css" /><div class="wf-width-cont surf-fc-widget"><div class="widget-container"><div class="external-cont"><iframe class="surf-fc-i" allowtransparency="true" src="//www.surf-forecast.com/breaks/Puerto-Marina/forecasts/widget/m" scrolling="no" frameborder="0" marginwidth="0" marginheight="0"></iframe></div></div></div>',
            ...
            Beach(
                ...
                description="Punta del Moral in Andalucia is a quite exposed beach and breakwater break that has fairly consistent surf. Winter and spring are the favoured times of year to visit. Offshore winds are from the north northwest. Waves just as likely from local windswells as from distant groundswells and the best swell direction is from the south southeast. The beach break provides left and right handers. A fairly popluar wave that can sometimes get crowded Beware of Pollution.",
                ...
                windsurf_y_kitesurf=3,
                people_to_water=3,
                surf_fore_cast_link='<link href="//www.surf-forecast.com/stylesheets/widget.css" media="screen" rel="stylesheet" type="text/css" /><div class="wf-width-cont surf-fc-widget"><div class="widget-container"><div class="external-cont"><iframe class="surf-fc-i" allowtransparency="true" src="//www.surf-forecast.com/breaks/Punta-del-Moral/forecasts/widget/a" scrolling="no" frameborder="0" marginwidth="0" marginheight="0"></iframe></div></div></div>',
            ...
            Beach(
                ...
                restaurants=5,
                pubs=4,
                surf_fore_cast_link='<link href="//www.surf-forecast.com/stylesheets/widget.css" media="screen" rel="stylesheet" type="text/css" /><div class="wf-width-cont surf-fc-widget"><div class="widget-container"><div class="external-cont"><iframe class="surf-fc-i" allowtransparency="true" src="//www.surf-forecast.com/breaks/Playa-El-Camaron/forecasts/widget/a" scrolling="no" frameborder="0" marginwidth="0" marginheight="0"></iframe></div></div></div>',
